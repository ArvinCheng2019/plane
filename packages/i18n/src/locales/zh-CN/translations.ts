...
export default {
  ...
  // ── 补充缺失的翻译 ──
  accordion_navigation_control: "折叠式侧边栏导航",
  account: "注销账号",
  add_labels: "添加标签",
  ...
  change_assignees: "指派给",
  change_estimate: "修改预估",
  ...
  copy_current_page_url_toast_success: "当前页面链接已复制到剪贴板。",
  copy_id: "复制 ID",
  ...
  copy_url_toast_success: "工作项链接已复制到剪贴板。",
  create_page: "新建页面",
  create_view: "新建视图",
  customize_navigation: "自定义导航",
  easy_to_hard: "由易到难",
  enable_description: "这有助于团队传达复杂度和工作量。",
  enter_number_of_projects: "输入项目数量",
  exporting_projects: "导出项目中",
  fibonacci: "斐波那契",
  ...
  nav_all_workspace_work_items: "查看所有工作项",
  nav_assigned_workspace_work_items: "查看指派给我的工作项",
  nav_created_workspace_work_items: "查看我创建的工作项",
  nav_home: "前往主页",
  nav_inbox: "前往收件箱",
  ...
  nav_subscribed_workspace_work_items: "查看订阅的工作项",
  ...
  preferences: "偏好设置",
  report_bug: "报告问题",
  settings_description: "在一处管理您的账号、工作区和项目偏好设置。",
  settings_moved_to_preferences: "时区和语言设置已移至偏好设置。",
  show_limited_projects_on_sidebar: "在侧边栏显示有限项目",
  squares: "方块",
  t_shirt_sizes: "T恤尺码",
  timezone_setting: "当前时区设置。",
  toggle_app_sidebar: "切换侧边栏",
  unassign_from_me: "取消指派给我",
  unlock: "解锁",
  unpin: "取消置顶",
  update_language: "修改界面语言",
  update_module_member: "修改成员",
  update_module_status: "修改状态",
  update_start_of_week: "修改每周第一天",
  update_theme: "修改界面主题",
  update_timezone: "修改时区",
  update_work_item_assignee: "指派给",
  update_work_item_cycle: "添加到周期",
  update_work_item_estimate: "修改预估",
  update_work_item_labels: "添加标签",
  update_work_item_module: "添加到模块",
  update_work_item_priority: "修改优先级",
  update_work_item_state: "修改状态",
} as const;
